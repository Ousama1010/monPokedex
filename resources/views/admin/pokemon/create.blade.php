                    ...
                    <form method="POST" action="{{ route('pokemons.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input id="hp" type="number" name="hp" value="{{ old('hp') }}" required class="mt-1 block w-full rounded-md shadow-sm border-gray-300" />
                                @error('hp')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input id="weight" type="number" name="weight" step="0.01" value="{{ old('weight') }}" required class="mt-1 block w-full rounded-md shadow-sm border-gray-300" />
                                @error('weight')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input id="height" type="number" name="height" step="0.01" value="{{ old('height') }}" required class="mt-1 block w-full rounded-md shadow-sm border-gray-300" />
                                @error('height')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="img_path" class="block font-medium text-sm text-gray-700">Image du Pokémon</label>
